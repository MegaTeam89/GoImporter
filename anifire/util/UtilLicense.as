package anifire.util
{
   ...
   public class UtilLicense
   {
      ...
      public static function get FX_HIDE() : Array
      {
         var _loc1_:Array = new Array();
         _loc1_.push("fadeInEx");
         _loc1_.push("circle_fade_out.swf");
         _loc1_.push("fadeOutEx");
         _loc1_.push("ncc_transition03.swf");
         _loc1_.push("ncc_transition04.swf");
         _loc1_.push("ncc_transition03b.swf");
         _loc1_.push("ncc_transition04b.swf");
         return _loc1_;
      }
   }
}
